...
const MapPlaceholder = dynamic(
  () => import("@/components/ui/map/MapPlaceholder"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[420px] w-full bg-slate-900 animate-pulse flex items-center justify-center rounded-xl text-slate-500 font-medium">
        Loading Satellite Farm Mapping Tiles...
      </div>
    ),
  }
);
